...
location_map = {
    ...
    "함경면": [35.0934, 126.3151], "부림면": [35.5186, 128.3241], "오성면": [37.0012, 126.9315],
    "가야면": [35.7954, 128.1408], "군남면": [37.9575, 127.0267], "서면": [38.2144, 127.4244],
    "단성면": [35.3115, 127.9463], "신광면": [35.1385, 126.4952]
}
